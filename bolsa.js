document.addEventListener("DOMContentLoaded", () => {
    ...
    // --- Funciones de Ayuda para el Carrito (LocalStorage) ---
    ...
    function saveCart(cart) {
        ...
        // Disparamos un evento de storage para que otras pestañas (si están abiertas) se actualicen.
    ...
    function renderItems() {
        const cart = getCart();
        itemsListContainer.innerHTML = ''; // Limpiamos la lista antes de volver a renderizar
    ...
    function updateSummary() {
        ...
        // Asumimos que el envío es gratis por ahora, como en el HTML.
    ...
    function addEventListenersToItems() {
        ...
        document.querySelectorAll('.btn-eliminar').forEach(button => {
            button.addEventListener('click', (e) => {
                ...
                saveCart(cart);
                renderItems(); // Volver a renderizar todo
            });
        });
        ...
        document.querySelectorAll('.item-cantidad-input').forEach(input => {
            input.addEventListener('change', (e) => {
                ...
                saveCart(cart);
                renderItems(); // Volver a renderizar para actualizar totales y la lista
            });
        });
    }
    ...
    vaciarBolsaBtn.addEventListener('click', () => {
        ...
        if (confirm('¿Estás seguro de que quieres vaciar tu bolsa?')) {
            saveCart([]); // Guardamos un array vacío
            renderItems();
        }
    });
